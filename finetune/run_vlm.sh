...
#     --output_dir save_model/sft-yesbut-moral-mixed-llava-v1.6-13b \
#     --bf16 \
...
CUDA_VISIBLE_DEVICES=2,3 accelerate launch  --config_file=./accelerate_configs/deepspeed_zero2_2.yaml \
    sft_vlm.py  \
    --dataset_name  data/llava-instruct-mix-vsft \
    --model_name_or_path llava-hf/llava-v1.6-mistral-7b-hf \
    --per_device_train_batch_size 4 \
    --gradient_accumulation_steps 4 \
    --output_dir save_model/sft-yesbut-moral-mixed-llava-v1.6-7b \
    --bf16 \
    --torch_dtype bfloat16 \
    --gradient_checkpointing \
    --logging_steps 25 \
