...
if __name__ == "__main__":
    ...
    processor.patch_size = None  # 例如 14，具体值需要根据模型来设定
    ...
    # yesbut
    # dataset = load_dataset("json", data_files={"train": "data/yesbut_v3/GPT4o_yesbut_moral_train_trainable.jsonl", "test": "data/yesbut_v3/GPT4o_yesbut_moral_dev_trainable.jsonl"}, cache_dir="data/tuo")
    dataset = load_dataset("json", data_files={"train": "data/yesbut_v3/GPT4o_yesbut_train_trainable.jsonl", "test": "data/yesbut_v3/GPT4o_yesbut_dev_trainable.jsonl"}, cache_dir="data/tuo")
    # dataset = load_dataset("json", data_files={"train": "./data/yesbut_v2/GPT4o_yesbut_title_train_trainable.jsonl", "test": "./data/yesbut_v2/GPT4o_yesbut_title_dev_trainable.jsonl"}, cache_dir="/data/huzhe/hf_cache")
