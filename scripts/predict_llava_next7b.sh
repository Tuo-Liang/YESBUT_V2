...
echo "llava eval"
echo "==============================="
CUDA_VISIBLE_DEVICES=1 python -u  predict_llava_next7b.py \
    --read_path ${data} \
    --write_path "results_nosplit/llava_next7b/results_llava_next7b_"${task}"_"${write_path_surffix} \
    --task ${task} \
...
# echo "llava eval"
# echo "==============================="
# python -u  predict_llava_next7b.py \
#     --read_path ${data} \
#     --write_path "results_nosplit/llava_next7b/results_llava_next7b_"${task}"_"${write_path_surffix} \
#     --task ${task} \
#     --image_folder ${image_folder}\
