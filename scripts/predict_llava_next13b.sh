...
echo "llava eval"
echo "==============================="
CUDA_VISIBLE_DEVICES=0 python -u  predict_llava_next13b.py \
    --read_path ${data} \
    --write_path "results_nosplit/llava_next13b/results_llava_next13b_"${task}"_"${write_path_surffix} \
    --task ${task} \
...
# echo "llava eval"
# echo "==============================="
# python -u  predict_llava_next13b.py \
#     --read_path ${data} \
#     --write_path "results_nosplit/llava_next13b/results_llava_next13b_"${task}"_"${write_path_surffix} \
#     --task ${task} \
#     --image_folder ${image_folder}\
