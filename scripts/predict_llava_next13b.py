...
def main():
    ...
    for sample in data:
        ...
        if args.gt_des:
            instruction = f"Based on the following description and image: {cur_caption} Tell me the best option in the following options who represents the deep semantics? \n{question} \nJust tell me the correct option by outputing corresponding letter (A, B, C, or D), no more explanation."
